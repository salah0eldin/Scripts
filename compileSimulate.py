...
parser.add_argument('--show_waveform', action='store_true', help='Show waveform at the end of the simulation')
args = parser.parse_args()

TOP_LEVEL_TB = args.top_level_tb  # Set the module name from command line argument
SHOW_WAVEFORM = args.show_waveform  # Set the show waveform option from command line argument
...
def run_simulation_with_spinner(command, description):
    ...
    colored_output = stdout.replace("Passed", f"{GREEN}Passed{RESET}").replace("Failed", f"{RED}Failed{RESET}")
...
if __name__ == "__main__":
    ...
    simulation_output = run_simulation_with_spinner(simulation_command, f"Simulating the module: {TOP_LEVEL_TB}...")
